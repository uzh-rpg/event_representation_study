...
def get_args_parser(add_help=True):
    parser = argparse.ArgumentParser(
        description="ev-YOLOv6 PyTorch Evaluating", add_help=add_help
    )
    # parser.add_argument("--file", type=str, required=True, default="/data/storage/datasets/gen1/h5_single_files")
    parser.add_argument(
