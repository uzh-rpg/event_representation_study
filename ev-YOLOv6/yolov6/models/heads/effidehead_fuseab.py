    ...
    def forward(self, x):
        if self.training:
            ...
            for i in range(self.nl):
                ...
                if self.use_dfl:
                    reg_output_af = reg_output_af.reshape(
            ...
            pred_bboxes_af = dist2bbox(
                reg_dist_list_af, anchor_points_af, box_format="xywh"
            )
...
def build_effidehead_layer(
    ...
    head_layers = nn.Sequential(
        ...
        # cls_pred0_af
        nn.Conv2d(
            in_channels=channels_list[chx[0]], out_channels=num_classes, kernel_size=1
        ),
        # reg_pred0_af
        nn.Conv2d(
            in_channels=channels_list[chx[0]],
        ...
        # cls_pred1_af
        nn.Conv2d(
            in_channels=channels_list[chx[1]], out_channels=num_classes, kernel_size=1
        ),
        # reg_pred1_af
        nn.Conv2d(
            in_channels=channels_list[chx[1]],
        ...
        # cls_pred2_af
        nn.Conv2d(
            in_channels=channels_list[chx[2]], out_channels=num_classes, kernel_size=1
        ),
        # reg_pred2_af
        nn.Conv2d(
            in_channels=channels_list[chx[2]],
