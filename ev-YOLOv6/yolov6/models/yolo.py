...
from yolov6.models.swin_transformer_v2 import *
from yolov6.models.reppan import *
from yolov6.models.resnet50 import resnet
from yolov6.utils.events import LOGGER
from yolov6.models.learned_repr import QuantizationLayer


class Model(nn.Module):
    """ev-YOLOv6 model with backbone, neck and head.
    ...
    def __init__(
        ...
        if self.args.representation == "LearnedRepresentation":
            self.quantization_layer = QuantizationLayer(
                dim=(6, 240, 304), image_size=self.args.img_size
            ).to(
                "cuda"
