...
def draw_bounding_box_on_image(img, boxes):
    from torchvision import transforms
    from torchvision.utils import draw_bounding_boxes
    import torchvision

    cv2.imwrite("/data/storage/nzubic/ChessPieces/images/aa.png", img)
    slika = cv2.imread("/data/storage/nzubic/ChessPieces/images/aa.png")
    cv2.rectangle(
        slika,
